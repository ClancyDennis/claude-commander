...
impl AgentManager {
    ...
    pub async fn create_agent(
        ...
        self.create_agent_with_pipeline(working_dir, github_url, selected_instruction_files, Vec::new(), source, app_handle, None, None).await
    }
    ...
    pub async fn create_agent_with_skills(
        ...
        self.create_agent_with_pipeline(working_dir, github_url, None, generated_skill_names, source, app_handle, None, None).await
    }
    ...
    fn spawn_claude_process(
        ...
        let api_key_mode = std::env::var("CLAUDE_CODE_API_KEY_MODE")

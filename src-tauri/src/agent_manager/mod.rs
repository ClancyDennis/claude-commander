...
impl AgentManager {
    ...
    pub async fn create_agent_with_pipeline(
        ...
        // Skills are generated by the caller before this function is called
        let _selected_instruction_files = selected_instruction_files;
        let generated_skill_names = Vec::new();
